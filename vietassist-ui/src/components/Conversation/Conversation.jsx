...
import data from "../../data/vietassist.json";
import axios from "axios";
>>>>>>> 1cee1fcb23ee8fc8fc804b0d34dbd4f72458545f
import io from "socket.io-client";
import { useDispatch, useSelector } from "react-redux";
import {
  addToChatHistory,
  replaceLastResponseMsg,
  updateChatHistory,
  updateCurrentPos,
...
>>>>>>> 1cee1fcb23ee8fc8fc804b0d34dbd4f72458545f
          ...
          >
            ...
            <CardActions>
              ...
              >
                ...
                <IconButton
                  onClick={() => handleFavoriteBtn(p.id)}
                  aria-label="add to favorites"
                >
                  <FavoriteIcon
                    sx={{ color: p.isFavorite ? red[700] : grey[500] }}
                  />
                </IconButton>
              </Stack>
            </CardActions>
  ...
  return (
    ...
    >
      ...
      >
        <Messages chatHistory={temp} handleItemClick={handleItemClick} />
      </Box>
      <Box
        p={2}
        sx={{
